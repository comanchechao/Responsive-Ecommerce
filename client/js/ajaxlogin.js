      ...
      success: function (json) {
        if (json["success"] == true) {
          if (json["enable_redirect"]) {
            ...
            $(".pt-account").load(
              "index.php?route=plaza/login/headerHtml #top-links ul.pt-account li"
            );
        ...
        if (json["success"] == true) {
          ...
          if (json["error_firstname"] != "") {
            $(".error-firstname")
              ...
              .html(json["error_firstname"])
              .show();
          }
          if (json["error_lastname"] != "") {
            $(".error-lastname")
              .addClass("text-danger")
              .html(json["error_lastname"])
              .show();
          }
          if (json["error_email"] != "") {
            $(".error-email")
              .addClass("text-danger")
              .html(json["error_email"])
              .show();
          }
          if (json["error_telephone"] != "") {
            $(".error-telephone")
              .addClass("text-danger")
              .html(json["error_telephone"])
              .show();
          }
          if (json["error_custom_field"] != "") {
            $(".error-custom")
              .addClass("text-danger")
              .html(json["error_custom_field"])
              .show();
          }
          if (json["error_password"] != "") {
            $(".error-password")
              .addClass("text-danger")
              .html(json["error_password"])
              .show();
          }
          if (json["error_confirm"] != "") {
            $(".error-confirm")
              .addClass("text-danger")
              .html(json["error_confirm"])
              .show();
          }

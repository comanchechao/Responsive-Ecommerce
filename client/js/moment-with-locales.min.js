!(function (a, b) {
  ...
  function r(b) {
    q(this, b),
      ...
      ve === !1 && ((ve = !0), a.updateOffset(this), (ve = !1));
  }
  function s(a) {
  ...
  function X(a, b) {
    return a.isValid()
      ? ((b = Y(b, a.localeData())), (Ke[b] = Ke[b] || W(b)), Ke[b](a))
  ...
  function fa(a, b) {
    return a
      ? c(this._months)
        ...
        : this._months[
            (this._months.isFormat || of).test(b) ? "format" : "standalone"
          ][a.month()]
      : c(this._months)
      ? this._months
  ...
  function ga(a, b) {
    return a
      ? c(this._monthsShort)
        ...
        : this._monthsShort[of.test(b) ? "format" : "standalone"][a.month()]
      : c(this._monthsShort)
      ? this._monthsShort
  ...
  function ha(a, b, c) {
    ...
    return c
      ? "MMM" === b
        ? ((e = nf.call(this._shortMonthsParse, g)), e !== -1 ? e : null)
        : ((e = nf.call(this._longMonthsParse, g)), e !== -1 ? e : null)
      : "MMM" === b
      ? ((e = nf.call(this._shortMonthsParse, g)),
        e !== -1
          ? e
          : ((e = nf.call(this._longMonthsParse, g)), e !== -1 ? e : null))
      : ((e = nf.call(this._longMonthsParse, g)),
        e !== -1
          ? e
          : ((e = nf.call(this._shortMonthsParse, g)), e !== -1 ? e : null));
  }
  ...
  function ma(a) {
    return this._monthsParseExact
      ...
      : (j(this, "_monthsShortRegex") || (this._monthsShortRegex = rf),
  ...
  function na(a) {
    return this._monthsParseExact
      ...
      : (j(this, "_monthsRegex") || (this._monthsRegex = sf),
  ...
  function Ia(a, b, c) {
    ...
    return c
      ? "dddd" === b
        ? ((e = nf.call(this._weekdaysParse, g)), e !== -1 ? e : null)
        : "ddd" === b
        ? ((e = nf.call(this._shortWeekdaysParse, g)), e !== -1 ? e : null)
        : ((e = nf.call(this._minWeekdaysParse, g)), e !== -1 ? e : null)
      : "dddd" === b
      ? ((e = nf.call(this._weekdaysParse, g)),
        e !== -1
          ? e
          : ((e = nf.call(this._shortWeekdaysParse, g)),
            e !== -1
              ? e
              : ((e = nf.call(this._minWeekdaysParse, g)),
                e !== -1 ? e : null)))
      : "ddd" === b
      ? ((e = nf.call(this._shortWeekdaysParse, g)),
        e !== -1
  ...
  function Na(a) {
    return this._weekdaysParseExact
      ...
      : (j(this, "_weekdaysRegex") || (this._weekdaysRegex = yf),
  ...
  function Oa(a) {
    return this._weekdaysParseExact
      ...
      : (j(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = zf),
  ...
  function Pa(a) {
    return this._weekdaysParseExact
      ...
      : (j(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Af),
    ...
    if (null !== b) {
      ...
      if (((b.abbr = a), null != Ff[a]))
        ...
        if (null == Ff[b.parentLocale])
          return (
            Gf[b.parentLocale] || (Gf[b.parentLocale] = []),
            Gf[b.parentLocale].push({ name: a, config: b }),
            null
          );
    ...
    return (
      c &&
        ...
        ((b =
          c[ef] < 0 || c[ef] > 11
            ? ef
            : c[ff] < 1 || c[ff] > ea(c[df], c[ef])
            ? ff
            : c[gf] < 0 ||
              c[gf] > 24 ||
              (24 === c[gf] && (0 !== c[hf] || 0 !== c[jf] || 0 !== c[kf]))
            ? gf
            : c[hf] < 0 || c[hf] > 59
            ? hf
            : c[jf] < 0 || c[jf] > 59
  ...
  function lb(b) {
    ...
    var c,
      ...
      i = h.length,
      j = 0;
    for (e = Y(b._f, b._locale).match(Ie) || [], c = 0; c < e.length; c++)
      (f = e[c]),
        (d = (h.match($(f, b)) || [])[0]),
        d &&
  ...
  function $c() {
    var a = this._data;
    return (
      (this._milliseconds = dg(this._milliseconds)),
  ...
  function pd(a, b) {
    return (
      void 0 !== ug[a] &&
      (void 0 === b ? ug[a] : ((ug[a] = b), "s" === a && (ug.ss = b - 1), !0))
    );
  }
  function qd(a) {
  ...
  function Ld(a) {
    return (a ? "" : "[mÃºlt] ") + "[" + ih[this.day()] + "] LT[-kor]";
  }
  function Md(a) {
  ...
  function Wd(a, b, c, d) {
    ...
    return 1 === a
      ? e + Td(a, b, c[0], d)
      : b
      ? e + (Ud(a) ? Vd(c)[1] : Vd(c)[0])
      : d
      ? e + Vd(c)[1]
      : e + (Ud(a) ? Vd(c)[1] : Vd(c)[2]);
  }
  function Xd(a, b, c) {
    return c
      ? b % 10 === 1 && b % 100 !== 11
  ...
  function be(a, b, c) {
    ...
    switch (c) {
      ...
      case "MM":
        return d + (ae(a) ? "miesiÄ…ce" : "miesiÄ™cy");
      case "yy":
  ...
  function ge(a, b, c, d) {
    ...
    switch (c) {
      ...
      case "mm":
        return b || d ? e + (fe(a) ? "minÃºty" : "minÃºt") : e + "minÃºtami";
        break;
      case "h":
        return b ? "hodina" : d ? "hodinu" : "hodinou";
      case "hh":
        return b || d ? e + (fe(a) ? "hodiny" : "hodÃ­n") : e + "hodinami";
        break;
      case "d":
        return b || d ? "deÅˆ" : "dÅˆom";
      case "dd":
        return b || d ? e + (fe(a) ? "dni" : "dnÃ­") : e + "dÅˆami";
        break;
      case "M":
  ...
  var of = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
    pf = "January_February_March_April_May_June_July_August_September_October_November_December".split(
      "_"
    ),
  ...
  a.defineLocale("ar-ly", {
    ...
    preparse: function (a) {
      return a.replace(/\u200f/g, "").replace(/ØŒ/g, ",");
    },
  ...
  a.defineLocale("ar-sa", {
    ...
    preparse: function (a) {
      return a
        .replace(/[Ù¡Ù¢Ù£Ù¤Ù¥Ù¦Ù§Ù¨Ù©Ù ]/g, function (a) {
          return Dg[a];
        })
        .replace(/ØŒ/g, ",");
    },
  ...
  a.defineLocale("az", {
    ...
    a.defineLocale("bg", {
      ...
      monthsShort: "ÑÐ½Ñ€_Ñ„ÐµÐ²_Ð¼Ð°Ñ€_Ð°Ð¿Ñ€_Ð¼Ð°Ð¹_ÑŽÐ½Ð¸_ÑŽÐ»Ð¸_Ð°Ð²Ð³_ÑÐµÐ¿_Ð¾ÐºÑ‚_Ð½Ð¾Ðµ_Ð´ÐµÐº".split(
        "_"
      ),
  ...
  a.defineLocale("bn", {
    ...
    monthsShort: "à¦œà¦¾à¦¨à§_à¦«à§‡à¦¬_à¦®à¦¾à¦°à§à¦š_à¦à¦ªà§à¦°_à¦®à§‡_à¦œà§à¦¨_à¦œà§à¦²_à¦†à¦—_à¦¸à§‡à¦ªà§à¦Ÿ_à¦…à¦•à§à¦Ÿà§‹_à¦¨à¦­à§‡_à¦¡à¦¿à¦¸à§‡".split(
      "_"
    ),
    ...
    weekdaysMin: "à¦°à¦¬à¦¿_à¦¸à§‹à¦®_à¦®à¦™à§à¦—_à¦¬à§à¦§_à¦¬à§ƒà¦¹à¦ƒ_à¦¶à§à¦•à§à¦°_à¦¶à¦¨à¦¿".split(
      "_"
    ),
    longDateFormat: {
      LT: "A h:mm à¦¸à¦®à§Ÿ",
  ...
  a.defineLocale("bo", {
    ...
    monthsShort: "à½Ÿà¾³à¼‹à½–à¼‹à½‘à½„à¼‹à½”à½¼_à½Ÿà¾³à¼‹à½–à¼‹à½‚à½‰à½²à½¦à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½‚à½¦à½´à½˜à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½–à½žà½²à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½£à¾”à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½‘à¾²à½´à½‚à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½–à½‘à½´à½“à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½–à½¢à¾’à¾±à½‘à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½‘à½‚à½´à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½–à½…à½´à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½–à½…à½´à¼‹à½‚à½…à½²à½‚à¼‹à½”_à½Ÿà¾³à¼‹à½–à¼‹à½–à½…à½´à¼‹à½‚à½‰à½²à½¦à¼‹à½”".split(
      "_"
    ),
    ...
    weekdaysMin: "à½‰à½²à¼‹à½˜à¼‹_à½Ÿà¾³à¼‹à½–à¼‹_à½˜à½²à½‚à¼‹à½‘à½˜à½¢à¼‹_à½£à¾·à½‚à¼‹à½”à¼‹_à½•à½´à½¢à¼‹à½–à½´_à½”à¼‹à½¦à½„à½¦à¼‹_à½¦à¾¤à½ºà½“à¼‹à½”à¼‹".split(
      "_"
    ),
    longDateFormat: {
      LT: "A h:mm",
    ...
    a.defineLocale("ca", {
      ...
      ordinal: function (a, b) {
        var c =
          1 === a ? "r" : 2 === a ? "n" : 3 === a ? "r" : 4 === a ? "t" : "Ã¨";
        return ("w" !== b && "W" !== b) || (c = "a"), a + c;
      },
      week: { dow: 1, doy: 4 },
    });
  var Pg = "leden_Ãºnor_bÅ™ezen_duben_kvÄ›ten_Äerven_Äervenec_srpen_zÃ¡Å™Ã­_Å™Ã­jen_listopad_prosinec".split(
      "_"
    ),
    Qg = "led_Ãºno_bÅ™e_dub_kvÄ›_Ävn_Ävc_srp_zÃ¡Å™_Å™Ã­j_lis_pro".split("_");
  a.defineLocale("cs", {
    months: Pg,
    monthsShort: Qg,
    ...
    a.defineLocale("de-at", {
      ...
      monthsShort: "JÃ¤n._Febr._Mrz._Apr._Mai_Jun._Jul._Aug._Sept._Okt._Nov._Dez.".split(
        "_"
      ),
      monthsParseExact: !0,
    ...
    a.defineLocale("de-ch", {
      ...
      monthsShort: "Jan._Febr._MÃ¤rz_April_Mai_Juni_Juli_Aug._Sept._Okt._Nov._Dez.".split(
        "_"
      ),
      monthsParseExact: !0,
      weekdays: "Sonntag_Montag_Dienstag_Mittwoch_Donnerstag_Freitag_Samstag".split(
  ...
  var Tg = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
      "_"
    ),
  ...
  var Vg = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
      "_"
    ),
  ...
  a.defineLocale("fa", {
    ...
    meridiem: function (a, b, c) {
      return a < 12 ? "Ù‚Ø¨Ù„ Ø§Ø² Ø¸Ù‡Ø±" : "Ø¨Ø¹Ø¯ Ø§Ø² Ø¸Ù‡Ø±";
    },
    calendar: {
  ...
  var Zg = "nolla yksi kaksi kolme neljÃ¤ viisi kuusi seitsemÃ¤n kahdeksan yhdeksÃ¤n".split(
      " "
    ),
    $g = [
      "nolla",
  ...
  var _g = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split(
      "_"
    ),
  ...
  a.defineLocale("hi", {
    months: "à¤œà¤¨à¤µà¤°à¥€_à¤«à¤¼à¤°à¤µà¤°à¥€_à¤®à¤¾à¤°à¥à¤š_à¤…à¤ªà¥à¤°à¥ˆà¤²_à¤®à¤ˆ_à¤œà¥‚à¤¨_à¤œà¥à¤²à¤¾à¤ˆ_à¤…à¤—à¤¸à¥à¤¤_à¤¸à¤¿à¤¤à¤®à¥à¤¬à¤°_à¤…à¤•à¥à¤Ÿà¥‚à¤¬à¤°_à¤¨à¤µà¤®à¥à¤¬à¤°_à¤¦à¤¿à¤¸à¤®à¥à¤¬à¤°".split(
      "_"
    ),
  ...
  var ih = "vasÃ¡rnap hÃ©tfÅ‘n kedden szerdÃ¡n csÃ¼tÃ¶rtÃ¶kÃ¶n pÃ©nteken szombaton".split(
    " "
  );
  a.defineLocale("hu", {
    ...
    monthsShort: "jan_feb_mÃ¡rc_Ã¡pr_mÃ¡j_jÃºn_jÃºl_aug_szept_okt_nov_dec".split(
      "_"
    ),
    ...
    a.defineLocale("ka", {
      months: {
        standalone: "áƒ˜áƒáƒœáƒ•áƒáƒ áƒ˜_áƒ—áƒ”áƒ‘áƒ”áƒ áƒ•áƒáƒšáƒ˜_áƒ›áƒáƒ áƒ¢áƒ˜_áƒáƒžáƒ áƒ˜áƒšáƒ˜_áƒ›áƒáƒ˜áƒ¡áƒ˜_áƒ˜áƒ•áƒœáƒ˜áƒ¡áƒ˜_áƒ˜áƒ•áƒšáƒ˜áƒ¡áƒ˜_áƒáƒ’áƒ•áƒ˜áƒ¡áƒ¢áƒ_áƒ¡áƒ”áƒ¥áƒ¢áƒ”áƒ›áƒ‘áƒ”áƒ áƒ˜_áƒáƒ¥áƒ¢áƒáƒ›áƒ‘áƒ”áƒ áƒ˜_áƒœáƒáƒ”áƒ›áƒ‘áƒ”áƒ áƒ˜_áƒ“áƒ”áƒ™áƒ”áƒ›áƒ‘áƒ”áƒ áƒ˜".split(
          "_"
        ),
        format: "áƒ˜áƒáƒœáƒ•áƒáƒ áƒ¡_áƒ—áƒ”áƒ‘áƒ”áƒ áƒ•áƒáƒšáƒ¡_áƒ›áƒáƒ áƒ¢áƒ¡_áƒáƒžáƒ áƒ˜áƒšáƒ˜áƒ¡_áƒ›áƒáƒ˜áƒ¡áƒ¡_áƒ˜áƒ•áƒœáƒ˜áƒ¡áƒ¡_áƒ˜áƒ•áƒšáƒ˜áƒ¡áƒ¡_áƒáƒ’áƒ•áƒ˜áƒ¡áƒ¢áƒ¡_áƒ¡áƒ”áƒ¥áƒ¢áƒ”áƒ›áƒ‘áƒ”áƒ áƒ¡_áƒáƒ¥áƒ¢áƒáƒ›áƒ‘áƒ”áƒ áƒ¡_áƒœáƒáƒ”áƒ›áƒ‘áƒ”áƒ áƒ¡_áƒ“áƒ”áƒ™áƒ”áƒ›áƒ‘áƒ”áƒ áƒ¡".split(
          "_"
        ),
      },
      ...
      relativeTime: {
        future: function (a) {
          return /(áƒ¬áƒáƒ›áƒ˜|áƒ¬áƒ£áƒ—áƒ˜|áƒ¡áƒáƒáƒ—áƒ˜|áƒ¬áƒ”áƒšáƒ˜)/.test(a)
            ? a.replace(/áƒ˜$/, "áƒ¨áƒ˜")
            : a + "áƒ¨áƒ˜";
        },
        past: function (a) {
          return /(áƒ¬áƒáƒ›áƒ˜|áƒ¬áƒ£áƒ—áƒ˜|áƒ¡áƒáƒáƒ—áƒ˜|áƒ“áƒ¦áƒ”|áƒ—áƒ•áƒ”)/.test(
            ...
            ? a.replace(/(áƒ˜|áƒ”)$/, "áƒ˜áƒ¡ áƒ£áƒ™áƒáƒœ")
            : /áƒ¬áƒ”áƒšáƒ˜/.test(a)
            ? a.replace(/áƒ¬áƒ”áƒšáƒ˜$/, "áƒ¬áƒšáƒ˜áƒ¡ áƒ£áƒ™áƒáƒœ")
            : void 0;
        },
  ...
  a.defineLocale("kk", {
    ...
    a.defineLocale("km", {
      ...
      weekdaysShort: "áž¢áž¶áž‘áž·ážáŸ’áž™_áž…áŸáž“áŸ’áž‘_áž¢áž„áŸ’áž‚áž¶ážš_áž–áž»áž’_áž–áŸ’ážšáž ážŸáŸ’áž”ážáž·áŸ_ážŸáž»áž€áŸ’ážš_ážŸáŸ…ážšáŸ".split(
        "_"
      ),
      weekdaysMin: "áž¢áž¶áž‘áž·ážáŸ’áž™_áž…áŸáž“áŸ’áž‘_áž¢áž„áŸ’áž‚áž¶ážš_áž–áž»áž’_áž–áŸ’ážšáž ážŸáŸ’áž”ážáž·áŸ_ážŸáž»áž€áŸ’ážš_ážŸáŸ…ážšáŸ".split(
        "_"
      ),
      longDateFormat: {
        LT: "HH:mm",
  ...
  a.defineLocale("kn", {
    ...
    monthsShort: "à²œà²¨_à²«à³†à²¬à³à²°_à²®à²¾à²°à³à²šà³_à²à²ªà³à²°à²¿à²²à³_à²®à³†à³•_à²œà³‚à²¨à³_à²œà³à²²à³†à³–_à²†à²—à²¸à³à²Ÿà³_à²¸à³†à²ªà³à²Ÿà³†à²‚à²¬_à²…à²•à³à²Ÿà³†à³‚à³•à²¬_à²¨à²µà³†à²‚à²¬_à²¡à²¿à²¸à³†à²‚à²¬".split(
      "_"
    ),
    monthsParseExact: !0,
  ...
  a.defineLocale("ky", {
    ...
    a.defineLocale("lo", {
      ...
      meridiem: function (a, b, c) {
        return a < 12 ? "àº•àº­àº™à»€àºŠàº»à»‰àº²" : "àº•àº­àº™à»àº¥àº‡";
      },
      calendar: {
    ...
    translate: function (a, b, c) {
      ...
      return 1 === c.length
        ? b
          ? d[0]
          : d[1]
        : a + " " + ph.correctGrammaticalCase(a, d);
    },
  };
  a.defineLocale("me", {
    ...
    a.defineLocale("ml", {
      ...
      meridiemHour: function (a, b) {
        return (
          12 === a && (a = 0),
          ("à´°à´¾à´¤àµà´°à´¿" === b && a >= 4) ||
          "à´‰à´šàµà´š à´•à´´à´¿à´žàµà´žàµ" === b ||
          "à´µàµˆà´•àµà´¨àµà´¨àµ‡à´°à´‚" === b
            ? a + 12
            : a
        );
      },
  ...
  var wh = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_"
    ),
  ...
  var Ah = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_"
    ),
  ...
  var Gh = "styczeÅ„_luty_marzec_kwiecieÅ„_maj_czerwiec_lipiec_sierpieÅ„_wrzesieÅ„_paÅºdziernik_listopad_grudzieÅ„".split(
      "_"
    ),
    Hh = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrzeÅ›nia_paÅºdziernika_listopada_grudnia".split(
      "_"
    );
  a.defineLocale("pl", {
    months: function (a, b) {
  ...
  var Lh = "januÃ¡r_februÃ¡r_marec_aprÃ­l_mÃ¡j_jÃºn_jÃºl_august_september_oktÃ³ber_november_december".split(
      "_"
    ),
    Mh = "jan_feb_mar_apr_mÃ¡j_jÃºn_jÃºl_aug_sep_okt_nov_dec".split("_");
  a.defineLocale("sk", {
    months: Lh,
    monthsShort: Mh,
    ...
    translate: function (a, b, c) {
      ...
      return 1 === c.length
        ? b
          ? d[0]
          : d[1]
        : a + " " + Nh.correctGrammaticalCase(a, d);
    },
  };
    ...
    translate: function (a, b, c) {
      ...
      return 1 === c.length
        ? b
          ? d[0]
          : d[1]
        : a + " " + Oh.correctGrammaticalCase(a, d);
    },
  };
  a.defineLocale("sr", {
    months: "januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar".split(
  ...
  a.defineLocale("ta", {
      ...
      return (
        ...
        "à®¯à®¾à®®à®®à¯" === b
          ? a < 2
            ? a
            : a + 12
          : "à®µà¯ˆà®•à®±à¯ˆ" === b || "à®•à®¾à®²à¯ˆ" === b
          ? a
          : "à®¨à®£à¯à®ªà®•à®²à¯" === b && a >= 10
          ? a
          : a + 12
      );
    },
    ...
    a.defineLocale("te", {
      months: "à°œà°¨à°µà°°à°¿_à°«à°¿à°¬à±à°°à°µà°°à°¿_à°®à°¾à°°à±à°šà°¿_à°à°ªà±à°°à°¿à°²à±_à°®à±‡_à°œà±‚à°¨à±_à°œà±‚à°²à±†à±–_à°†à°—à°¸à±à°Ÿà±_à°¸à±†à°ªà±à°Ÿà±†à°‚à°¬à°°à±_à°…à°•à±à°Ÿà±‹à°¬à°°à±_à°¨à°µà°‚à°¬à°°à±_à°¡à°¿à°¸à±†à°‚à°¬à°°à±".split(
        "_"
      ),
      monthsShort: "à°œà°¨._à°«à°¿à°¬à±à°°._à°®à°¾à°°à±à°šà°¿_à°à°ªà±à°°à°¿._à°®à±‡_à°œà±‚à°¨à±_à°œà±‚à°²à±†à±–_à°†à°—._à°¸à±†à°ªà±._à°…à°•à±à°Ÿà±‹._à°¨à°µ._à°¡à°¿à°¸à±†.".split(
        "_"
      ),
      monthsParseExact: !0,
  ...
  var Rh = "pagh_waâ€™_chaâ€™_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_");
  a.defineLocale("tlh", {
  ...
  a.defineLocale("tr", {
    ...
    a.defineLocale("uk", {
      ...
      calendar: {
        sameDay: qe("[Ð¡ÑŒÐ¾Ð³Ð¾Ð´Ð½Ñ– "),
        nextDay: qe("[Ð—Ð°Ð²Ñ‚Ñ€Ð° "),
        lastDay: qe("[Ð’Ñ‡Ð¾Ñ€Ð° "),
        nextWeek: qe("[Ð£] dddd ["),
        lastWeek: function () {
          switch (this.day()) {
            case 0:
            ...
            case 5:
            case 6:
              return qe("[ÐœÐ¸Ð½ÑƒÐ»Ð¾Ñ—] dddd [").call(this);
            case 1:
            case 2:
            case 4:
              return qe("[ÐœÐ¸Ð½ÑƒÐ»Ð¾Ð³Ð¾] dddd [").call(this);
          }
        },
        sameElse: "L",
      },

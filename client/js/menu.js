$(document).ready(function () {
  ...
  $(".horizontal-menu .mega-menu-container").each(function () {
    if ($(this).hasClass("right")) {
      if ($(this).hasClass("full-width")) {
        ...
        var dropdownRight =
          $(".horizontal-menu.pt-menu-bar").outerWidth() - dropdown.left;

        var i =
          dropdownRight +
          $(this).outerWidth() -
          $(".horizontal-menu.pt-menu-bar").outerWidth();
    ...
    if ($(this).hasClass("left")) {
      if ($(this).hasClass("full-width") == false) {
        ...
        var i =
          dropdown.left +
          $(this).outerWidth() -
          (menu.left + $(".horizontal-menu.pt-menu-bar").outerWidth());
  ...
  $(".pt-menu").each(function () {
    ...
    if ($mobile) {
      $(this)
        .find(".li-top-item .top-click-show")
        .click(function () {
      ...
      $(this)
        .find(".li-second-items .second-click-show")
        .click(function () {
          ...
          if (flag) {
            ...
            if (effect == "none") {
              $(this)
                .closest(".li-second-items")
                .find(".flyout-third-items")
                .hide();
            }

...
var ptquickview = {
  initQuickViewContainer: function () {
    ...
    $("div.quickview-container").load(
      "index.php?route=plaza/quickview/appendcontainer"
    );
  },

  appendCloseFrameLink: function () {
    $("div#quickview-content").prepend(
      "<a href='javascript:void(0);' class='a-qv-close' onclick='ptquickview.closeQVFrame()'>" +
        $("#qv-text-close").val() +
        "</a>"
    );
  },
